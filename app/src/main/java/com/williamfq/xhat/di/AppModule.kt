...
import com.williamfq.domain.utils.AudioTrimmerImpl
import com.williamfq.domain.utils.SpeechToTextService
import com.williamfq.domain.utils.SpeechToTextServiceImpl
...
abstract class UtilsModule {
    ...
    @Binds
    @Singleton
    abstract fun bindAudioTrimmer(audioTrimmerImpl: AudioTrimmerImpl): AudioTrimmer

    @Binds
    @Singleton
    abstract fun bindSpeechToTextService(speechToTextServiceImpl: SpeechToTextServiceImpl): SpeechToTextService
}